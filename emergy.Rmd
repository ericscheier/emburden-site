...
**The headline finding:** for HEII_norm, the full control set (7
indicators including income, poverty, PM, CO2, intensity, electricity +
cooking access) reaches only **adj-R² = 0.22**. About **80% of HEII_norm
variance is orthogonal to standard indicators** — this is the "emergy
alpha" the framework is designed to surface.

For `heii_ratio_p10_p90` (within-country energy inequality) the numbers
are even lower — emissions-only R²=−0.03, income-only R²=0.03, full=0.20.
Within-country inequality is genuinely independent of country-average
indicators.
