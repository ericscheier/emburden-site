...
```{r fig-odum-overlay, fig.height=8.5, fig.width=14, fig.cap="HEII framework in Odum ESL overlaid on the Abel-2023 spectral hierarchy. Sources (circles) at raw primary-fuel transformity. Producers (bullet-nosed hexagons) at electricity-basis transformity. Grid (bullet-tank) + Household (hexagon) at country-median. Gap diamonds (interactions). Cultural info + Culture configs in the top-hierarchy lenses. 213 countries as regional dots at their grid transformity, sized by log(population). Powered by emburdensynth::geom_odum_* — the first R grammar-of-graphics library for Odum ESL symbols (Bundle U)."}
...
# BASE — Abel-2023 spectral lenses
